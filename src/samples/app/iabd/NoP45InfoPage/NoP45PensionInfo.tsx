          ...
          <div className='govuk-grid-row'>
            <div className='govuk-grid-column-two-thirds'>
              ...
              <p className='govuk-body'>
                ...
                {t('WE_NEED_CERTAIN_DETAILS_FROM_YOUR_P45_PENSION')}
              </p>

              <p className='govuk-body'>{t('YOU_CAN_CONTACT_YOUR_PENSION_TO_GET_AN_UPDATED')}</p>

              <p className='govuk-body'>
                {t('IF_YOU_HAVE_LOST_CONTACT_WITH_YOUR_PENSION')}
                {t('WE_WILL_THEN_UPDATE_YOUR_PENSION_FOR_YOU')}
              </p>
...
export default NoP45PensionInfo;
