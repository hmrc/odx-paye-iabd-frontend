...
// interface for props
interface HmrcOdxMimicASentenceProps extends PConnFieldProps {
...
function HmrcOdxMimicASentence(props: HmrcOdxMimicASentenceProps) {
...
export default withConfiguration(HmrcOdxMimicASentence);
