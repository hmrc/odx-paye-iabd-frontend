...
const _DateErrorFormatter = (message, propertyName) => {
  ...
  if (originalDate && !hasMoreThanThreeHyphens(message)) {
    ...
    let shortPropertyName;
    switch (propertyName) {
      case 'Enter employment paid date':
        shortPropertyName = 'EMPLOYMENT_PAY_DATE';
        break;
      case 'Enter employment start date':
        shortPropertyName = 'EMPLOYMENT_START_DATE';
        break;
      case 'Enter leaving date':
        shortPropertyName = 'LEAVING_DATE';
        break;
      case 'Enter first payment date':
        shortPropertyName = 'ENTER_FIRST_PAYMENT_DATE';
        break;
      default:
        shortPropertyName = 'DATE';
        break;
    }
