...
import { pyReviewRawMetadata, regionChildrenResolved } from './mock'; // inport test data
...
export const Primary = () => {
  ...
  window.PCore.getFormUtils = () => {
    return {
      getEditableFields: () => {
        return [{ name: 'HmrcOdxGdsSummaryCard' }];
      }
    };
  };
