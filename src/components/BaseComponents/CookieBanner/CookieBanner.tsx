...
const CookieBanner = () => {
  ...
  const isLocationCookies: boolean = useLocation().pathname === '/cookies';
  useEffect(() => {
  ...
  const setCookie = (consent: boolean) => {
    ...
    setConfirmationMessage(
      consent ? 'COOKIE_BANNER.CONFIRMATION_ACCEPTED' : 'COOKIE_BANNER.CONFIRMATION_REJECTED'
    );
  };
        ...
        <>
          {isVisible && (
            <div
              ...
              data-nosnippet
              role='region'
              aria-label='Cookies on HMRC Services'
            >
