...
module.exports = (env, argv) => {
  ...
  ); // Enable gzip and brotli compression //  Exclude constellation-core and bootstrap-shell files since //    client receives these files in gzip and brotli format
  ...
  if (webpackMode === 'development') {
    ...
    publicPathValue = '/';
  } // need to set mode to 'development' to get LiveReload to work //  and for debugger statements to not be stripped out of the bundle
  ...
  initConfig = {
    ...
    output: {
      ...
      path: path.resolve(__dirname, 'dist') // publicPath: publicPathValue
    },
